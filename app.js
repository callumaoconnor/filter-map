...
function createPopup(currentFeature) {
  ...
  const popup = new mapboxgl.Popup({ closeOnClick: true })
    ...
    .setHTML('<p style="padding-bottom: 8px; font-family: Bebasneuepro, sans-serif; font-size: 20px!important; font-weight: 400!important; text-transform: capitalize;">' + currentFeature.properties[config.popupInfo] + "</p>" + '<a href=' + currentFeature.properties[config.popupLink] + '><img style="height: 100px; fit: cover" src=' + currentFeature.properties[config.popupImage] + "></a>")
    .addTo(map);
}
...
function buildLocationList(locationData) {
  ...
  locationData.features.forEach(function (location, i) {
    ...
    link.innerHTML =
      '<p style="line-height: 1.25; padding-bottom: 12px; padding-top: 15px; font-family: Bebasneuepro, sans-serif; font-size: 26px; font-weight: 400!important; text-transform: capitalize;">' + prop[columnHeaders[0]] + "</p>" + '<img style="padding-bottom: 15px; max-height: 250px; fit: cover" src=' + prop[config.popupImage] + ">";
