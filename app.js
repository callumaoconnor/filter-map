...
function createPopup(currentFeature) {
  ...
  const popup = new mapboxgl.Popup({ closeOnClick: true })
    ...
    .setHTML("<h3>" + currentFeature.properties[config.popupInfo] + "</h3>" + "<a href=" + currentFeature.properties[config.popupLink] + "><img src=" + currentFeature.properties[config.popupImage] + "></a>")
    .addTo(map);
}
...
function buildLocationList(locationData) {
  ...
  locationData.features.forEach(function (location, i) {
    ...
    link.innerHTML =
      '<p style="line-height: 1.25; padding-bottom: 12px; padding-top: 15px font-family: Bebasneuepro, sans-serif; font-size: 20px; font-weight: 400!important; text-transform: capitalize;">' + prop[columnHeaders[0]] + "</p>" + '<img style="padding-bottom: 15px" src=' + prop[config.popupImage] + ">";
