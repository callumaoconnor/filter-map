...
function createPopup(currentFeature) {
  ...
  const popup = new mapboxgl.Popup({ closeOnClick: true })
    ...
    .setHTML("<h2>" + currentFeature.properties[config.popupInfo] + "</h2>" + "<a href=" + currentFeature.properties[config.popupLink] + "><img src=" + currentFeature.properties[config.popupImage] + "></a>")
    .addTo(map);
}
