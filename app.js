...
function createPopup(currentFeature) {
  ...
  const popup = new mapboxgl.Popup({ closeOnClick: true })
    ...
    .setHTML('<p style="padding-bottom: 8px; font-family: Bebasneuepro, sans-serif; font-size: 20px!important; font-weight: 400!important; text-transform: capitalize;">' + currentFeature.properties[config.popupInfo] + "</p>" + "<a href=" + currentFeature.properties[config.popupLink] + "><img style= "height: 250px" src=" + currentFeature.properties[config.popupImage] + "></a>")
    .addTo(map);
}
