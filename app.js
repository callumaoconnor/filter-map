...
function createPopup(currentFeature) {
  ...
  const popup = new mapboxgl.Popup({ closeOnClick: true })
    ...
    .setHTML("<h3>" + currentFeature.properties[config.popupInfo] + "</h3>" + "<img src=" + currentFeature.properties[config.popupImage] + ">")
    .addTo(map);
}
...
function buildLocationList(locationData) {
  ...
  locationData.features.forEach(function (location, i) {
    ...
    link.innerHTML =
      '<p style="line-height: 1.25; padding-bottom: 10px; padding-top: 10px">' + prop[columnHeaders[0]] + "</p>" + "<img style="padding-bottom: 10px; padding-top: 10px" src=" + prop[config.popupImage] + ">";
