...
function createPopup(currentFeature) {
  ...
  const popup = new mapboxgl.Popup({ closeOnClick: true })
    ...
    .setHTML('<a href=' + currentFeature.properties[config.popupLink] + '><p style="padding-bottom: 8px; font-family: Bebasneuepro, sans-serif; font-size: 20px!important; font-weight: 400!important; text-transform: capitalize;">' + currentFeature.properties[config.popupInfo] + "</p>" + '<img style="max-height: 120px; width: 100%; object-fit: cover" src=' + currentFeature.properties[config.popupImage] + "></a>")
    .addTo(map);
}
...
function buildLocationList(locationData) {
  ...
  locationData.features.forEach(function (location, i) {
    ...
    learnMore.innerHTML = 
      '<a href="'+ prop[config.popupLink] +'"><p style="color: #2399d5!important; padding-bottom: 32px; padding-top: -15px;">Learn more</p></a>';
...
$(document).ready(function(){
if (pinLat && pinLng) {map.fire('click', { latLng: centerMap, point: map.project(centerMap), originalEvent: {} })}
});
